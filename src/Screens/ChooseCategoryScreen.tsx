    ...
    <ScrollView>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.row}>
          ...
          <CategoryCard
            title="Sculptor"
            image={require('../../assets/Images/sculptor.png')}
          />
        </View>
        ...
        <View style={styles.row}>
          <CategoryCard
            title="Actor"
            image={require('../../assets/Images/actor.png')}
          />
          <CategoryCard
            title="Singer"
...
const styles = StyleSheet.create({
  background: {flex: 1, resizeMode: 'cover', padding: 50,backgroundColor: 'rgba(255,255,255,0.9)',},
  container: {
    flex: 1,
